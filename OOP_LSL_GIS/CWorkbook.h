...
public:
	...
	void SaveAs(VARIANT& Filename, VARIANT& FileFormat, VARIANT& Password, VARIANT& WriteResPassword, VARIANT& ReadOnlyRecommended, VARIANT& CreateBackup, long AccessMode, VARIANT& ConflictResolution, VARIANT& AddToMru, VARIANT& TextCodepage, VARIANT& TextVisualLayout, VARIANT& Local, VARIANT& WorkIdentity)
	{
		...
		InvokeHelper(0xc66, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Filename, &FileFormat, &Password, &WriteResPassword, &ReadOnlyRecommended, &CreateBackup, AccessMode, &ConflictResolution, &AddToMru, &TextCodepage, &TextVisualLayout, &Local, &WorkIdentity);
	}
	...
	CString PublishToDocs(LPCTSTR Title, long DisclosureScope, VARIANT& OverwriteUrl)
	{
		...
		InvokeHelper(0xcf7, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, Title, DisclosureScope, &OverwriteUrl);
		return result;
	}
	LPDISPATCH LookUpInDocs(VARIANT& Filename)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xcf8, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Filename);
		return result;
	}
	...
	{
		BOOL result;
		InvokeHelper(0xca0, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_AutoSaveOn(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xca0, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	void UpgradeComments()
	{
		InvokeHelper(0xccf, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
