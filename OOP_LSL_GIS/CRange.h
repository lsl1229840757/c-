...
public:
	...
	void ExportAsFixedFormat(long Type, VARIANT& Filename, VARIANT& Quality, VARIANT& IncludeDocProperties, VARIANT& IgnorePrintAreas, VARIANT& From, VARIANT& To, VARIANT& OpenAfterPublish, VARIANT& FixedFormatExtClassPtr, VARIANT& WorkIdentity)
	{
		...
		InvokeHelper(0xc67, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Type, &Filename, &Quality, &IncludeDocProperties, &IgnorePrintAreas, &From, &To, &OpenAfterPublish, &FixedFormatExtClassPtr, &WorkIdentity);
	}
	VARIANT get_HasRichDataType()
	{
		VARIANT result;
		InvokeHelper(0xcee, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void ShowCard()
	{
		InvokeHelper(0xcca, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xcd1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	...
	void ConvertToLinkedDataType(long ServiceID, LPCTSTR LanguageCulture)
	{
		...
		InvokeHelper(0xcda, DISPATCH_METHOD, VT_EMPTY, NULL, parms, ServiceID, LanguageCulture);
	}
	VARIANT get_LinkedDataTypeState()
	{
		VARIANT result;
		InvokeHelper(0xcdb, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void SetCellDataTypeFromCell(LPDISPATCH SourceCell)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0xcdd, DISPATCH_METHOD, VT_EMPTY, NULL, parms, SourceCell);
	}
	void DataTypeToText()
	{
		InvokeHelper(0xcde, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	VARIANT get_HasSpill()
	{
		VARIANT result;
		InvokeHelper(0xcdf, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_SpillingToRange()
	{
		LPDISPATCH result;
		InvokeHelper(0xce0, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_SpillParent()
	{
		LPDISPATCH result;
		InvokeHelper(0xce1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	void RefreshLinkedDataType(VARIANT& DomainID)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xce3, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &DomainID);
	}
